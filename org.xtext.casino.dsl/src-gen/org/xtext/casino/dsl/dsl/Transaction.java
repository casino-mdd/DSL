 ...
 * </p>
 * <ul>
 *   <li>{@link org.xtext.casino.dsl.dsl.Transaction#getType <em>Type</em>}</li>
...
public interface Transaction extends EObject
{
   ...
   * @see #setType(String)
   * @see org.xtext.casino.dsl.dsl.DslPackage#getTransaction_Type()
   * @model
   * @generated
   */
  String getType();
  ...
  /**
   * Sets the value of the '{@link org.xtext.casino.dsl.dsl.Transaction#getType <em>Type</em>}' attribute.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
