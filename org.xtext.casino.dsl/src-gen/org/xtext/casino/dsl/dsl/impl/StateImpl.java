 ...
 * </p>
 * <ul>
 *   <li>{@link org.xtext.casino.dsl.dsl.impl.StateImpl#getName <em>Name</em>}</li>
 *   <li>{@link org.xtext.casino.dsl.dsl.impl.StateImpl#getAction <em>Action</em>}</li>
 *   <li>{@link org.xtext.casino.dsl.dsl.impl.StateImpl#getReducer <em>Reducer</em>}</li>
 * </ul>
 *
 * @generated
 */
public class StateImpl extends AbstractFrontElementImpl implements State
{
  ...
  public Action getAction()
  {
    if (action != null && action.eIsProxy())
    {
      ...
      {
        if (eNotificationRequired())
          eNotify(new ENotificationImpl(this, Notification.RESOLVE, DslPackage.STATE__ACTION, oldAction, action));
      }
    }
    return action;
  }
  ...
  public void setAction(Action newAction)
  {
    ...
    action = newAction;
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, DslPackage.STATE__ACTION, oldAction, action));
  }
  ...
  public Reducer getReducer()
  {
    if (reducer != null && reducer.eIsProxy())
    {
      ...
      {
        if (eNotificationRequired())
          eNotify(new ENotificationImpl(this, Notification.RESOLVE, DslPackage.STATE__REDUCER, oldReducer, reducer));
      }
    }
    return reducer;
  }
  ...
  public void setReducer(Reducer newReducer)
  {
    ...
    reducer = newReducer;
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, DslPackage.STATE__REDUCER, oldReducer, reducer));
  }
  ...
  public Object eGet(int featureID, boolean resolve, boolean coreType)
  {
    switch (featureID)
    {
      case DslPackage.STATE__NAME:
        return getName();
      case DslPackage.STATE__ACTION:
        if (resolve) return getAction();
        return basicGetAction();
      case DslPackage.STATE__REDUCER:
