 ...
 * </p>
 * <ul>
 *   <li>{@link org.xtext.casino.dsl.dsl.impl.AbstractClassImpl#getAttribute <em>Attribute</em>}</li>
 *   <li>{@link org.xtext.casino.dsl.dsl.impl.AbstractClassImpl#getMethodClass <em>Method Class</em>}</li>
 *   <li>{@link org.xtext.casino.dsl.dsl.impl.AbstractClassImpl#getAnnotation <em>Annotation</em>}</li>
 *   <li>{@link org.xtext.casino.dsl.dsl.impl.AbstractClassImpl#getAbstractMethod <em>Abstract Method</em>}</li>
 * </ul>
 *
 * @generated
 */
public class AbstractClassImpl extends EclassImpl implements AbstractClass
{
  ...
  {
    return DslPackage.Literals.ABSTRACT_CLASS;
  }
  ...
  public EList<Attribute> getAttribute()
  {
    if (attribute == null)
    {
      attribute = new EObjectContainmentEList<Attribute>(Attribute.class, this, DslPackage.ABSTRACT_CLASS__ATTRIBUTE);
    }
    return attribute;
  }
  ...
  public EList<MethodBack> getMethodClass()
  {
    if (methodClass == null)
    {
      methodClass = new EObjectContainmentEList<MethodBack>(MethodBack.class, this, DslPackage.ABSTRACT_CLASS__METHOD_CLASS);
    }
    return methodClass;
  }
    ...
    if (annotation != null && annotation.eIsProxy())
    {
      ...
      if (annotation != oldAnnotation)
      {
        if (eNotificationRequired())
          eNotify(new ENotificationImpl(this, Notification.RESOLVE, DslPackage.ABSTRACT_CLASS__ANNOTATION, oldAnnotation, annotation));
      }
    }
    return annotation;
  }
  ...
  public void setAnnotation(Annotation newAnnotation)
  {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, DslPackage.ABSTRACT_CLASS__ANNOTATION, oldAnnotation, annotation));
  }
  ...
  public EList<AbstractMethod> getAbstractMethod()
  {
    ...
    {
      abstractMethod = new EObjectContainmentEList<AbstractMethod>(AbstractMethod.class, this, DslPackage.ABSTRACT_CLASS__ABSTRACT_METHOD);
    }
  ...
  public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs)
  {
    switch (featureID)
    {
      case DslPackage.ABSTRACT_CLASS__ATTRIBUTE:
        return ((InternalEList<?>)getAttribute()).basicRemove(otherEnd, msgs);
      case DslPackage.ABSTRACT_CLASS__METHOD_CLASS:
        return ((InternalEList<?>)getMethodClass()).basicRemove(otherEnd, msgs);
      case DslPackage.ABSTRACT_CLASS__ABSTRACT_METHOD:
  ...
  public Object eGet(int featureID, boolean resolve, boolean coreType)
  {
    switch (featureID)
    {
      ...
      case DslPackage.ABSTRACT_CLASS__ANNOTATION:
