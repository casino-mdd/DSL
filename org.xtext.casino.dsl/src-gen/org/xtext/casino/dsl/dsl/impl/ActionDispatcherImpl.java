 ...
 * </p>
 * <ul>
 *   <li>{@link org.xtext.casino.dsl.dsl.impl.ActionDispatcherImpl#getName <em>Name</em>}</li>
 *   <li>{@link org.xtext.casino.dsl.dsl.impl.ActionDispatcherImpl#getType <em>Type</em>}</li>
 * </ul>
 *
 * @generated
 */
public class ActionDispatcherImpl extends AbstractFrontElementImpl implements ActionDispatcher
{
  ...
  {
    return DslPackage.Literals.ACTION_DISPATCHER;
  }
  ...
  public void setName(String newName)
  {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, DslPackage.ACTION_DISPATCHER__NAME, oldName, name));
  }
  ...
  public ActionCreator getType()
  {
    if (type != null && type.eIsProxy())
    {
      ...
      {
        if (eNotificationRequired())
          eNotify(new ENotificationImpl(this, Notification.RESOLVE, DslPackage.ACTION_DISPATCHER__TYPE, oldType, type));
      }
    }
    return type;
  }
  ...
  public void setType(ActionCreator newType)
  {
    ...
    type = newType;
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, DslPackage.ACTION_DISPATCHER__TYPE, oldType, type));
  }
  ...
  public Object eGet(int featureID, boolean resolve, boolean coreType)
  {
    switch (featureID)
    {
      case DslPackage.ACTION_DISPATCHER__NAME:
        return getName();
      case DslPackage.ACTION_DISPATCHER__TYPE:
