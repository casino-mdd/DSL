 ...
 * </p>
 * <ul>
 *   <li>{@link org.xtext.casino.dsl.dsl.impl.LayerSegmentRelationImpl#getLayerSegment <em>Layer Segment</em>}</li>
 * </ul>
 *
 * @generated
 */
public class LayerSegmentRelationImpl extends MinimalEObjectImpl.Container implements LayerSegmentRelation
{
  ...
  {
    return DslPackage.Literals.LAYER_SEGMENT_RELATION;
  }
  ...
  public void setLayerSegment(String newLayerSegment)
  {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, DslPackage.LAYER_SEGMENT_RELATION__LAYER_SEGMENT, oldLayerSegment, layerSegment));
  }
  ...
  public Object eGet(int featureID, boolean resolve, boolean coreType)
  {
    switch (featureID)
    {
      case DslPackage.LAYER_SEGMENT_RELATION__LAYER_SEGMENT:
