...
public class LibraryImpl extends MinimalEObjectImpl.Container implements Library
{
  ...
  {
    return DslPackage.Literals.LIBRARY;
  }
  ...
  public void setName(String newName)
  {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, DslPackage.LIBRARY__NAME, oldName, name));
  }
  ...
  public EList<Annotation> getAnnotation()
  {
    if (annotation == null)
    {
      annotation = new EObjectContainmentEList<Annotation>(Annotation.class, this, DslPackage.LIBRARY__ANNOTATION);
    }
    return annotation;
  }
